    ...
    while ($row = mysqli_fetch_assoc($results)) {
        ...
        if ($password == $resultPassword) {
            ...
            if (isset($_POST['remember_me'])) {
                ...
                setcookie("remid", $id, time() + 3600 * 24 * 30, "/");
                setcookie("rempassword", $password, time() + 3600 * 24 * 30, "/");
            } else {
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    ...
                    <form action="#" method="POST">
                        <div class="mb-3">
                            <input type="text" name="id" id="id" class="form-control" placeholder="Use your University Identity Number" required value="<?php echo $rememberedid; ?>" />
                        </div>
                        <div class="mb-3">
                            <input type="password" name="password" class="form-control" placeholder="Use your Stupack Password" required value="<?php echo $rememberedpassword; ?>" />
                        </div>
                        <div class="mb-4">
